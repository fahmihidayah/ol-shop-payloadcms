...
export function CategoriesShowcase({ categoryShowcase }: CategoriesShowcaseProps) {
  if (!categoryShowcase?.enabled || categoryShowcase.categories?.length === 0) return null

  const categories = categoryShowcase.categories as Category[]

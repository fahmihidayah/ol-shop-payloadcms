...
import { AddressFormDialog, AddressFormData } from '@/modules/addresses/components'
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        {addresses.length === 0 ? (
          <div className="flex items-center justify-center border border-gray-200 rounded-lg bg-gray-100/50 border-dashed py-20">
            <Button variant="outline" size="sm" onClick={() => setIsDialogOpen(true)}>
              <Plus className="mr-2 h-4 w-4" />
              Add New Address
            </Button>
